...
import org.webpieces.react.basesvr.YourCompanyServer;
import org.webpieces.react.services.DevConfig;
import org.webpieces.react.services.DevServerUtil;
import org.webpieces.react.services.YourCompanyDevelopmentServer;
...
public class DevelopmentServer extends YourCompanyDevelopmentServer {
	...
	public DevelopmentServer(boolean usePortZero) {
		super("reactpatterns", usePortZero);
	}
