package org.webpieces.react.web.tags;
...
public class MyHtmlTagCreator implements HtmlTagCreator {
	...
	public List<Tag> createTags() {
		...
		tags.add(new CustomTag("/org/webpieces/react/web/tags/mytag.tag"));
		tags.add(new IdTag(converter, "/org/webpieces/react/web/tags/id.tag"));
		
		//you can also override(subclass or whatever) any tag by replacing it in the map
		//This replaces the field tag
		//put(new FieldTag(converter, "/org/webpieces/react/base/tags/field.tag"));
